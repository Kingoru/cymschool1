    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="text-white">
                ...
                <p><i class="far fa-star"></i> Clasificación: {{$course->rating}}</p>
            </div>
        </div>
    </section>
            ...
            <section class="card mb-12">
                ...
                <ul class="ml-4 mb-4">
                    @foreach ($course->goals as $goal)
                        <li class="text-gray-700 text-base"><i class="fas fa-check text-gray-600 mr-2"></i>{{$goal->name}}</i></li>
                    @endforeach
                </ul>
            </section>
            <section class="mb-12">
                <h1 class="font-bold text-3xl mb-8">Temario</h1>
